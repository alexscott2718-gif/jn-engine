...
Named **52/93** placeable FourCCs; the rest have `InitObject fn` pinned.
...
| `3ROC` | — (name pending Phase 0) | `FUN_0043d840` | 1 |
| `3BAL` | — (name pending Phase 0) | `FUN_0040f710` | 1 |
| `3SOL` | — (name pending Phase 0) | `FUN_0044bee0` | 1 |
...
| `3OMT` | — (name pending Phase 0) | `FUN_00434530` | 1 |
| `3TUR` | — (name pending Phase 0) | `FUN_0044c6f0` | 1 |
...
| `3AIO` | — (name pending Phase 0) | `FUN_0040ae30` | 1 |
...
| `3SUV` | — (name pending Phase 0) | `FUN_0040b1b0` | 1 |
| `3TES` | — (name pending Phase 0) | `FUN_00445870` | 1 |
| `3SHE` | C3DSheen | `FUN_0043f920` | 1 |
| `3DAI` | C3DAI | `FUN_00407a40` | 1 |
| `3FLE` | — (name pending Phase 0) | `FUN_00419760` | 1 |
...
| `3SPH` | — (name pending Phase 0) | `FUN_00463b30` | 3 |
| `3TEL` | — (name pending Phase 0) | `FUN_00445600` | 1 |
| `3LIG` | — (name pending Phase 0) | `FUN_00461bb0` | 1 |
...
| `3KIT` | — (name pending Phase 0) | `FUN_0042b800` | 1 |
| `3ULT` | C3DUltraLord | `FUN_00448310` | 1 |
| `3CUB` | — (name pending Phase 0) | `FUN_004614e0` | 3 |
| `3HUG` | C3DHugh | `FUN_00420390` | 1 |
| `3DIG` | — (name pending Phase 0) | `FUN_00416eb0` | 1 |
| `3SAI` | — (name pending Phase 0) | `FUN_0043ecc0` | 1 |
