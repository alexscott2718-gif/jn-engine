...
> **Not to be confused with [`asset-catalog.md`](./asset-catalog.md)** (hyphen).
> That one is the hand-annotated visual reference behind the gallery portal.
> **This** file is the generated truth table, and is regenerated by
> `tools/build_asset_catalog.py` rather than edited.
